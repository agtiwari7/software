...
class Registration(ft.Column):
    def __init__(self, page, view):
        ...
        self.name_field = ft.TextField(label="Library Name", max_length=30, prefix_icon=ft.icons.VERIFIED_USER_OUTLINED, on_submit=lambda e: self.address_field.focus(), capitalization=ft.TextCapitalization.WORDS)
