...
class Fees(ft.Column):
    def __init__(self, page, session_value):
        ...
        self.search_tf = ft.TextField(label="Name / Contact / Aadhar / Fees / Joining", capitalization=ft.TextCapitalization.WORDS, width=700, bgcolor="#44CCCCCC", on_submit=self.fetch_data)
        self.search_btn = ft.ElevatedButton("Search", on_click=self.fetch_data, width=extras.main_eb_width, color=extras.main_eb_color, bgcolor=extras.main_eb_bgcolor)
        ...
        self.due_fees_data_table = ft.DataTable(
            ...
            columns=[
                ft.DataColumn(ft.Text("Days", size=extras.data_table_header_size, weight=extras.data_table_header_weight, color=extras.data_table_header_color), on_sort=self.sort_handler),
                ...
                ft.DataColumn(ft.Text("Shift", size=extras.data_table_header_size, weight=extras.data_table_header_weight, color=extras.data_table_header_color)),
        ...
        self.due_fees_list_view_container = ft.Container(self.due_list_view, margin=15, expand=True)
        ...
        self.pay_fees_data_table = ft.DataTable(
            ...
            show_bottom_border=True,
            columns=[
                ft.DataColumn(ft.Text("Name", size=extras.data_table_header_size, weight=extras.data_table_header_weight, color=extras.data_table_header_color), on_sort=self.pay_fees_sort_handler),
                ft.DataColumn(ft.Text("Contact", size=extras.data_table_header_size, weight=extras.data_table_header_weight, color=extras.data_table_header_color)),
                ft.DataColumn(ft.Text("Aadhar", size=extras.data_table_header_size, weight=extras.data_table_header_weight, color=extras.data_table_header_color)),
                ft.DataColumn(ft.Text("Fees", size=extras.data_table_header_size, weight=extras.data_table_header_weight, color=extras.data_table_header_color)),
        ...
        self.pay_fees_list_view_container = ft.Container(self.pay_fees_list_view, margin=15, expand=True)
        ...
        self.tabs = ft.Tabs(
                    ...
                    tabs=[
                        ft.Tab(
                            text="Due(s)",
                            content=self.due_fees_list_view_container
                        ),
                        ft.Tab(
                            text="Pay",
                            content=ft.Container(ft.Column([self.search_container, self.divider, self.pay_fees_list_view_container]))
                        ),
                    ],
                )
...
# due tab, functionalities is started from here
                ...
                if self.due_fees_data:
                    for row in self.due_fees_data:
                        ...
                        if difference <= 0:
                            ...
                            action_cell = ft.DataCell(ft.IconButton(icon=ft.icons.REMOVE_RED_EYE_OUTLINED, icon_color=extras.icon_button_color, on_click=lambda e, due_row=due_row: self.due_fees_popup(due_row)))
    ...
    def due_fees_popup(self, due_row):
        self.dlg_modal.content = ft.Column([ft.Container(ft.Image(src=due_row[-1], height=150, width=150), margin=10),
                                ...
                                ], horizontal_alignment=ft.CrossAxisAlignment.CENTER, width=450, height=475)
...
# pay tab functionalities is started from here
        ...
        try:
            ...
            if self.pay_fees_data:
                for row in self.pay_fees_data:
                    ...
                    action_cell = ft.DataCell(ft.ElevatedButton(text="Pay Fees", on_click=lambda e, row=row: self.pay_fees_popup(row), color=extras.main_eb_color, bgcolor=ft.colors.GREY_400))
                    cells.append(action_cell)
    ...
    def pay_fees_popup(self, row):
        ...
        self.dlg_modal.actions = [ft.ElevatedButton("Pay", width=extras.main_eb_width, color=extras.main_eb_color, bgcolor=extras.main_eb_bgcolor, on_click=lambda e: self.pay_clicked(row, new_date_str)),
